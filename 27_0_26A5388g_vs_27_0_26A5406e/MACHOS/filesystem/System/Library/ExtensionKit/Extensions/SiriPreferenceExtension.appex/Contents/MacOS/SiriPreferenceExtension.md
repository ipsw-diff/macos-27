...
+  __TEXT.__swift5_typeref: 0x7d28
   __TEXT.__swift5_capture: 0xbf8
-  __TEXT.__constg_swiftt: 0x323c
-  __TEXT.__swift5_reflstr: 0x2135
...
CStrings:
+ "calling revealElement(key:) via newSettingsViewModel"
```
