...
Symbols:
+ ___block_descriptor_89_a8_32s40s48s56s64s72s_e5_v8?0l
...
Functions:
~ -[TIKeyboardInputManagerChinese generateCompletions] : 748 -> 784
~ ___52-[TIKeyboardInputManagerChinese generateCompletions]_block_invoke : 864 -> 836
~ -[TIWordSearchChinesePhonetic chaiziCandidatesWithOperation:candidateResultSet:] : 2248 -> 2440
CStrings:
+ "i"
- "%@%@%@"
```
