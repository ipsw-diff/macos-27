...
+2459.402.0.0.0
+  __TEXT.__text: 0x19988c
+  __TEXT.__objc_methlist: 0x145a0
+  __TEXT.__const: 0xf60
+  __TEXT.__cstring: 0x2c241
+  __TEXT.__oslogstring: 0xb8a0
+  __TEXT.__gcc_except_tab: 0x9818
...
+  __TEXT.__objc_methname: 0x2c145
+  __TEXT.__objc_methtype: 0x31e2
...
+  __AUTH_CONST.__objc_const: 0x1fdc0
...
+ "%@\x1f%@"
+ "%{public}@"
+ "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.rHnVsJ/Sources/CoreSpotlight_frameworks/corespotlight/CoreSpotlight/CoreSpotlightStructuredQuery/StructuredQuery-Model/_CSQueryOperation.m"
+ "/System/Library/PrivateFrameworks/TCC.framework/Contents/MacOS/TCC"
+ "@\"<CSQueryCandidateEvaluator>\""
+ "@\"NSArray\"16@?0@\"NSString\"8"
+ "B24@0:8@\"CSSearchableItem\"16"
+ "B24@?0@8@\"NSDictionary\"16"
+ "CSDonationProgressFailedIndexes"
+ "CSPommesQueryCandidateEvaluator"
+ "CSQueryCandidateEvaluator"
+ "CSRankingModelQueryCandidateEvaluator"
...
+ "^{query_node=}"
+ "_candidateEvaluator"
+ "_candidateEvaluatorResolved"
+ "_candidateItems"
+ "_candidatesDelivered"
+ "_deliveredCandidateKeys"
+ "_drainBundleIDs"
+ "_drainToken"
+ "_errorWithCode:description:underlying:"
+ "_evaluator"
+ "_forceDispatchAllLocked:"
+ "_kMDItemApplicationLastLaunchedDate_Ranking"
+ "_memoCandidate"
+ "_memoResult"
+ "_processWorkItemsUpToRequestIDLocked:qosFloor:"
+ "_releaseContextCFRefs:"
+ "_retrievalEvaluator"
+ "_retrievalTree"
+ "_weightedTree"
+ "_xpcGroupedResultCounts"
+ "authorizationStatusForEntityType:"
+ "com.apple.notes.spotlightrecord"
+ "copyGroupedResultCounts"
+ "cs_enqueueDrainSentinelWithToken:retryCount:"
+ "cs_indexConnectionClassForTesting"
+ "cs_requiresInitializationForConnection:"
+ "cs_sendDrainResponseWithToken:outcome:queueDepth:"
+ "delete-donation-progress"
+ "deleteDonationProgressWithCompletionHandler:"
+ "deliverInjectedCandidatesAtStart"
...
+ "drb"
+ "drt"
+ "enqueueStartTimeCandidateInjection"
+ "evalResultForCandidate:"
+ "evaluate:item:pass:"
+ "f36@0:8@16@24C32"
+ "initWithRankingConfig:queryContext:"
+ "initWithRankingConfig:queryContext:queryStartTime:"
...
+ "performDrainWithToken:"
+ "pommesRankingConfiguration"
+ "predicateWithBlock:"
+ "queryStartTime"
+ "resolveCandidateEvaluatorIfNeeded"
+ "scoreCandidate:"
+ "setCandidateItems:"
+ "setDrainBundleIDs:"
+ "setDrainDonations:"
...
+ "v24@0:8@\"CSSearchableItem\"16"
+ "v24@0:8I16I20"
+ "v24@0:8^{PRContext=Q*^vSSb1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1^{__CFDictionary}^{__CFDictionary}^{__CFDictionary}d^{_MDPlistContainer}^v^?}16"
