...
-  __TEXT.__objc_methname: 0xdb5d
-  __TEXT.__objc_methtype: 0x3a0f
...
+  __TEXT.__objc_methname: 0xddcd
+  __TEXT.__objc_methtype: 0x3a86
   __TEXT.__swift5_capture: 0x1738
   __TEXT.__swift5_mpenum: 0x60
   __TEXT.__swift5_types2: 0x4
-  __TEXT.__gcc_except_tab: 0xd0c
-  __TEXT.__unwind_info: 0x4180
-  __TEXT.__eh_frame: 0x6938
-  __DATA_CONST.__const: 0x17ea0
...
+  __TEXT.__eh_frame: 0x6a50
+  __DATA_CONST.__const: 0x18130
...
- __LSUnregisterURL
CStrings:
+ "%{public}@ appsAwaitingTermination requested by %{public}@: %lu parked"
+ "(StoreItem) Fixed incorectly formatted bundleDirectoryName: %{public}@ -> %{public}@"
+ "15:03:37"
+ "@\"<ASDMacDaemonCallbackServiceProtocol>\"8@?0"
+ "@\"RBSProcessHandle\""
+ "@24@0:8@?16"
+ "ASDMacDaemonCallbackServiceProtocol"
...
+ "MacDaemonCallbackService"
+ "PARKING (app running)"
+ "PackageKit"
+ "Skipping LS unregister (leaving for agent) for %{public}@"
...
+ "[%@] Parking PackageKit install; ringing daemon check-in doorbell for: %{public}@"
+ "[%@] Quit Apple Event result for %{public}@: resultCode=%lld"
+ "[%@] RBS death monitor fired but no AppInstallInfo found for installID=%lld; cannot resume"
+ "[%@] RBS death monitor fired for installID=%lld bundleID=%{public}@: deadHandle=%{public}@ exitContext=%{public}@"
+ "[%@] RBS death-monitor lookup failed for bundleID=%{public}@ (not simply \"not found\"); leaving parked rather than risk swapping a running app: %{public}@"
+ "[%@] RBS death-monitor lookup for bundleID=%{public}@: handle=%{public}@ pid=%ld error=%{public}@"
+ "[%@] RBS lookup for bundleID=%{public}@ appPath=%{public}@: handle=%{public}@ pid=%ld -> %{public}@"
...
+ "[AppChange] App was moved: %{public}@ : %{public}@"
+ "[AppChange] App was removal (source=%{public}@) for %{public}@"
...
+ "[appsAwaitingTermination] Returning %lu parked app(s): %{public}@"
...
+ "cache-ats"
+ "cacheSession"
+ "com.apple.AppStoreDaemon.CallbackService"
