...
+ _symbolic $s16CallsAppServices19SafeModeBootSessionP
+ _symbolic ______p 16CallsAppServices19SafeModeBootSessionP
CStrings:
+ "SafeModeController bootID is different, clearing state"
+ "SafeModeController hours elapsed since last safeMode instance: %ld lastBootID: %s currentBootID: %s"
- "SafeModeController hours elapsed since last safeMode instance: %ld"
```
