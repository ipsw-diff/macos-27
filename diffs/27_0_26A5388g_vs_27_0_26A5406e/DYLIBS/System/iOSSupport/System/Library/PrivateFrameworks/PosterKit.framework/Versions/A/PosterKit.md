...
-  __TEXT.__objc_methlist: 0x14984
+355.0.0.0.0
+  __TEXT.__text: 0x13c0f0
+  __TEXT.__objc_methlist: 0x14ae4
   __TEXT.__const: 0x5664
-  __TEXT.__cstring: 0x93a4
-  __TEXT.__oslogstring: 0x6e19
+  __TEXT.__cstring: 0x93c4
+  __TEXT.__oslogstring: 0x6f19
   __TEXT.__gcc_except_tab: 0x24ec
   __TEXT.__ustring: 0x1c
   __TEXT.__swift5_typeref: 0xa060
...
-  __AUTH_CONST.__objc_const: 0x41860
...
+ GCC_except_table129
+ GCC_except_table94
+ OBJC_IVAR_$_PREditingFontAndContentStylePickerViewController._fontComponentDivider
+ OBJC_IVAR_$_PRImmutableEditingLookProperties._preferredFrostLevel
+ OBJC_IVAR_$_PRMutableEditingLookProperties._preferredFrostLevel
+ OBJC_IVAR_$_PRPosterConfigurableOptions._preferredFrostLevel
+ OBJC_IVAR_$_PRPosterWindow._posterRole
...
+ _objc_msgSend$_shouldHideFontComponentForCompactTime
+ _objc_msgSend$_updateFontComponentVisibilityForCompactTime
+ _objc_msgSend$contentInset
+ _objc_msgSend$fileSystemRepresentation
+ _objc_msgSend$homeScreenConfigVersionForPath:
+ _objc_msgSend$initWithIdentifier:displayName:initialTimeFontConfiguration:initialTitleColor:preferredFrostLevel:
+ _objc_msgSend$initWithPoster:type:variant:accentColor:size:configVersion:
+ _objc_msgSend$initWithTimeFontConfiguration:titlePosterColor:preferredFrostLevel:
+ _objc_msgSend$preferredFrostLevel
+ _objc_msgSend$reapStaleProcessScopedTemporaryDirectoriesWithPolicy:
+ _objc_msgSend$resetScrollPosition
+ _objc_msgSend$setFontComponentDivider:
+ _objc_msgSend$setPreferredFrostLevel:
+ _stat
...
- _objc_msgSend$initWithTimeFontConfiguration:titlePosterColor:
CStrings:
