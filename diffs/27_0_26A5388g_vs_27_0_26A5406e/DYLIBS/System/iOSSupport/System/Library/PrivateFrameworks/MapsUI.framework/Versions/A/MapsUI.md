...
-286.20.6.12.8
-  __TEXT.__text: 0x163d38
-  __TEXT.__objc_methlist: 0x156bc
+286.20.6.12.13
+  __TEXT.__text: 0x1644c0
+  __TEXT.__objc_methlist: 0x15724
   __TEXT.__const: 0x8050
   __TEXT.__swift5_typeref: 0x2f64
   __TEXT.__swift5_capture: 0x724
-  __TEXT.__cstring: 0x12215
+  __TEXT.__cstring: 0x12260
...
-  __DATA_CONST.__objc_selrefs: 0xa378
-  __DATA_CONST.__objc_protorefs: 0x1e8
+  __DATA_CONST.__objc_selrefs: 0xa3b0
...
-  __AUTH_CONST.__objc_const: 0x2baf8
+  __AUTH_CONST.__cfstring: 0x15540
+  __AUTH_CONST.__objc_const: 0x2bb60
...
+  __DATA.__data: 0x5540
   __DATA.__bss: 0x4a88
   __DATA.__common: 0x68
   __DATA_DIRTY.__objc_data: 0x5170
...
+ -[MULabeledValueActionRowView _updateForPlatterAvailability]
+ -[MUPlaceActivityDataProvider sharePreviewName]
+ -[MUPlaceHeaderSectionController headerSubtitle]
+ -[MUPlaceViewController headerSubtitle]
+ -[MUURLActivityProvider activityViewControllerLinkMetadata:]
+ -[MUURLActivityProvider activityViewControllerLinkPresentationMetadata:]
+ -[MUURLActivityProvider registerLinkMetadata:]
...
+ GCC_except_table826
+ GCC_except_table876
+ OBJC_IVAR_$_MUActivityDataProvider._resolvedShareURL
+ OBJC_IVAR_$_MUURLActivityProvider._cachedLinkMetadata
+ OBJC_IVAR_$_MUURLActivityProvider._linkMetadataBlock
+ _MKLocalizedStringForCurrentLocation
+ ___38-[MUActivityDataProvider linkMetadata]_block_invoke
+ ___38-[MUActivityDataProvider linkMetadata]_block_invoke_2
+ ___58+[MUURLActivityProvider activityProviderFromDataProvider:]_block_invoke_5
...
- GCC_except_table823
- GCC_except_table873
- __OBJC_$_PROP_LIST_MUInfoCardActionBarHost
- __OBJC_$_PROTOCOL_INSTANCE_METHODS_MUInfoCardActionBarHost
- __OBJC_$_PROTOCOL_METHOD_TYPES_MUInfoCardActionBarHost
- __OBJC_$_PROTOCOL_REFS_MUInfoCardActionBarHost
- __OBJC_LABEL_PROTOCOL_$_MUInfoCardActionBarHost
- __OBJC_PROTOCOL_$_MUInfoCardActionBarHost
- __OBJC_PROTOCOL_REFERENCE_$_MUInfoCardActionBarHost
CStrings:
+ "[Route Sharing] Placeholder destination"
+ "[Route Sharing] Placeholder origin"
+ "macOS Messages share with link metadata present; withholding plain URL item so only the rich preview is shared"
```
