...
-3600.52.4.0.0
-  __TEXT.__text: 0x8a7dc
-  __TEXT.__objc_methlist: 0x8a60
+3600.52.7.0.0
...
+ -[SVXOdeonSequenceValidator reset]
+ -[SVXOdeonSequenceValidator validateSequence:]
...
+ GCC_except_table570
+ GCC_except_table809
+ OBJC_IVAR_$_SVXOdeonSequenceValidator._lastSeen
+ OBJC_IVAR_$_SVXOdeonSequenceValidator._lock
+ _OBJC_CLASS_$_SVXOdeonSequenceValidator
+ _OBJC_METACLASS_$_SVXOdeonSequenceValidator
+ __OBJC_$_INSTANCE_METHODS_SVXOdeonSequenceValidator
+ __OBJC_$_INSTANCE_VARIABLES_SVXOdeonSequenceValidator
+ __OBJC_$_PROP_LIST_SVXOdeonSequenceValidator
+ __OBJC_CLASS_RO_$_SVXOdeonSequenceValidator
+ __OBJC_METACLASS_RO_$_SVXOdeonSequenceValidator
