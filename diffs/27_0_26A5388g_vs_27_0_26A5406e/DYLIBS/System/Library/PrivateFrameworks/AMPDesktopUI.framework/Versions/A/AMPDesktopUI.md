...
+  __DATA_CONST.__objc_selrefs: 0x8f58
...
-  __AUTH_CONST.__objc_const: 0x1b4f8
...
- _OBJC_CLASS_$_AMPLFrameworkClient
- _OBJC_CLASS_$_ImageDataCache
- _OBJC_CLASS_$_UXID
- _OBJC_CLASS_$_UXItem
- _OBJC_CLASS_$_UXItemSection
- _OBJC_CLASS_$_UXItemSectionList
- _OBJC_METACLASS_$_ImageDataCache
- _OBJC_METACLASS_$_NSImage
- _OBJC_METACLASS_$_UXID
- _OBJC_METACLASS_$_UXItem
- _OBJC_METACLASS_$_UXItemSection
- _OBJC_METACLASS_$_UXItemSectionList
- __os_log_disabled
- _arc4random
- _cache_create
- _cache_destroy
...
+ "TRACK_TABLE_RANKING_MAX_MEASURING_STRING"
- "       -> already purged"
- "%16.16llx-%16.16llx"
- "'%@':'%@' #%ld"
- "'%@':'%@' <%@>"
