...
-291.1.0.5.0
-  __TEXT.__text: 0x916b8
-  __TEXT.__objc_methlist: 0x21c
-  __TEXT.__swift5_typeref: 0x1731
...
CStrings:
+ " missing expected document/format parameters"
+ "%{public}s: %{public}s has no fileURL; cannot convert"
+ "%{public}s: export of %{public}s failed: %{public}@"
+ "%{public}s: exported %{public}s -> %{public}s"
+ "%{public}s: exporting %{public}s via %{public}s"
...
+ "export(fileURL:filename:type:)"
+ "no action metadata for "
