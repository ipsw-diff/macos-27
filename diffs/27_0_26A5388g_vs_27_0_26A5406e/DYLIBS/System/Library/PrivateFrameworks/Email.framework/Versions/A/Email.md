...
+ -[EMMailSearchUIBiomeLogger isHDBEnabled]
+ -[EMMailSearchUIBiomeLogger setIsHDBEnabled:]
...
+ CloudSharingLibraryCore.frameworkLibrary
+ OBJC_IVAR_$_EMMailSearchUIBiomeLogger._isHDBEnabled
...
+ ___block_descriptor_48_ea8_32s40r_e22_v16?0"NSDictionary"8l
...
+ getCloudSharingClass.softClass
...
CStrings:
+ " event:dimension buildType:%ld isHdbEnabled:%@"
+ "/System/Library/PrivateFrameworks/CloudSharing.framework/Contents/MacOS/CloudSharing"
