...
- "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.Y9bqR9/Sources/CameraCapture/CinematicFraming/Common/CinematicFramingShared.m %s: pixel buffer chroma %c%c%c%c format not supported"
- "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.Y9bqR9/Sources/CameraCapture/CinematicFraming/Common/CinematicFramingShared.m %s: pixel buffer luma %c%c%c%c format not supported"
- "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.Y9bqR9/Sources/CameraCapture/CinematicFraming/DeskCam/API/DeskCamSessionOptions.m %s: Device type (%d) not supported"
