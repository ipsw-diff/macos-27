...
-  __TEXT.__objc_methlist: 0xd024
+5037.0.11.200.0
+  __TEXT.__text: 0x164824
...
-  __AUTH_CONST.__const: 0xba30
-  __AUTH_CONST.__cfstring: 0x19c00
-  __AUTH_CONST.__objc_const: 0x1abc8
...
-  __DATA.__data: 0x4240
-  __DATA.__bss: 0x1ac28
+  __DATA.__objc_ivar: 0xd54
+  __DATA.__data: 0x42a0
+  __DATA.__bss: 0x1ac38
...
+ -[VCVoiceShortcutClient triggerExecutionBookmarkDataForUrlWrapper:error:]
...
+ GCC_except_table725
+ GCC_except_table887
+ OBJC_IVAR_$_WFSymbolIcon._bundle
...
+ __OBJC_$_INSTANCE_METHODS_VCVoiceShortcutClient(RecoverableShortcuts|MenuBar|Sting|AppIntents|TopHitContextual|VoiceShortcuts|AutoShortcuts|Accessibility|Staccato|Automations|ContextualActions|ShareSheet|Services|Suggestions)
...
+ ___73-[VCVoiceShortcutClient triggerExecutionBookmarkDataForUrlWrapper:error:]_block_invoke
+ ___73-[VCVoiceShortcutClient triggerExecutionBookmarkDataForUrlWrapper:error:]_block_invoke_2
...
+ _objc_msgSend$getTriggerExecutionBookmarkDataForUrlWrapper:completion:
...
+ getWFToolKitTelemetryLogObject.log
+ getWFToolKitTelemetryLogObject.onceToken
- -[VCVoiceShortcutClient refreshTriggerWithWorkflowID:triggerUUID:urlWrapper:completion:]
...
- ___88-[VCVoiceShortcutClient refreshTriggerWithWorkflowID:triggerUUID:urlWrapper:completion:]_block_invoke
...
- "%s [Triggers] Refreshing trigger with url access for trigger (workflow: %@, uuid: %@)"
- "-[VCVoiceShortcutClient refreshTriggerWithWorkflowID:triggerUUID:urlWrapper:completion:]"
