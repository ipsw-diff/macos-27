...
-  __TEXT.__eh_frame: 0xea98
+  __TEXT.__unwind_info: 0x7fd8
+  __TEXT.__eh_frame: 0xf250
...
-  __AUTH_CONST.__const: 0x161d8
+  __DATA_CONST.__got: 0xde0
+  __AUTH_CONST.__const: 0x16300
...
CStrings:
+ "\n\nTo develop with PCC you must meet certain eligibility requirements. To learn more and request access to the managed entitlement, sign into your Developer account and complete the entitlement request form.\n\nhttps://developer.apple.com/contact/request/private-cloud-compute/"
+ "AFM 3 Core Advanced"
...
+ "_x>TpzS\"geq$pz!#bR[QYxS%pT&y`dB=geW#fd%J"
+ "_x>TpzS\"geq$pz!#bR[QYx_yqzc!o@OyptJJ"
+ "_x>TpzS\"geq$pz!#bR[QYyO>fz&}f%JJ"
+ "_x>TpzS\"geq$pz!#o?BRgeg}f?b#^eO%oTcWo{_ypzBuoNJJ"
+ "_x>TpzS\"geq$pz!#o?BRgeg}f?b#bUcvoTyw"
+ "com.apple.fm_api.tool_calls_override"
+ "f?F\"YzS%pT&yYxg$qdBxfe_}o?B[o?_yoUZJ"
