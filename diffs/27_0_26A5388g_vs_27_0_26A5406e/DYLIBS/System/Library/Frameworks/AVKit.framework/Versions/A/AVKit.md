...
+1360.75.5.3.0
+  __TEXT.__text: 0xe90b8
+  __TEXT.__objc_methlist: 0xe788
...
+  __AUTH_CONST.__objc_const: 0x18f68
...
Symbols:
+ -[AVAuxiliaryControlsView layout]
+ -[AVMovableView _hasInteractiveControlInViewChainOfHitView:]
+ -[AVMovableView gestureRecognizer:shouldAttemptToRecognizeWithEvent:]
...
+ GCC_except_table755
+ GCC_except_table811
+ OBJC_IVAR_$_AVAuxiliaryControlsView._lastKnownWidth
+ _objc_msgSend$_hasInteractiveControlInViewChainOfHitView:
+ _objc_msgSend$avkit_isLanguageTranslation
- -[AVInlinePlaybackControlsViewController _updateDisplayModeControlsStateIfNeeded]
...
CStrings:
+ "H:|-(12)-[trimView]-(12)-|"
+ "V:|-(>=12)-[playbackControlsContainerView]-(12)-[trimView(38)]-(12)-|"
+ "\xc1"
- "H:|-(11)-[trimView]-(11)-|"
- "V:|-(24)-[playbackControlsContainerView]-(13)-[trimView(38)]"
- "V:|-(39)-[playbackControlsContainerView]-(13)-[trimView(38)]"
- "\xb1"
```
