...
CStrings:
+ "%s::handleStart: %s _pmuNub: %p ** configuration not found ** built 21:48:10 Aug  5 2026\n"
+ "%s::handleStart: ro=%d nvram=%d helper=%d %s _pmuNub: %p 0x%04x:0x%04x-0x%04x built 21:48:10 Aug  5 2026\n"
+ "%s::start: %s _pmuNub: %p ** configuration not found ** built 21:48:11 Aug  5 2026\n"
+ "%s::start: %s _pmuNub: %p built 21:48:11 Aug  5 2026\n"
+ "/AppleInternal/Library/BuildRoots/<BUILDROOT>/Library/Caches/com.apple.xbs/TemporaryDirectory.PXdcX4/Sources/AppleDialogPMU/SPMI/AppleDialogSPMIPMU.cpp"
